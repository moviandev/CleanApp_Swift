...
extension RemoteAddAccountTests {
    ...
    func makeAddAccountModel() -> AddAccountModel {
        return AddAccountModel(name: "test", email: "any_email@test.com", password: "any_password", passwordConfirmation: "any_password")
    }
    
    func makeAccountModel() -> AccountModel {
        return AccountModel(id: "any_id", name: "any_name", email: "any_email@test.com", password: "any_password")
    }
